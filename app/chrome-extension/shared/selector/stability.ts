/**
 * Selector Stability - selector stability assessment
 */
...
/**
 * Compute selector stability score
 */
...
/**
 * Add stability scores to selector candidates
 */
 ...
 * A negative number means a has priority, a positive number means b has priority
 */
export function compareSelectorCandidates(a: SelectorCandidate, b: SelectorCandidate): number {
  // 1. User-specified weight takes priority
  const aw = a.weight ?? 0;
  const bw = b.weight ?? 0;
