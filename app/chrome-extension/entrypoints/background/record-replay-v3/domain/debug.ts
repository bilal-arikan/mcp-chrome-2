 ...
 * @description Defines debugger state and protocol for Record-Replay V3
 */
...
export interface Breakpoint {
  /** ID of the node the breakpoint is on */
  nodeId: NodeId;
...
/** Debugger command type (extracted from the union type) */
