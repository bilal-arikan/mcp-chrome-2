 ...
 * @description Defines the schema and initialization logic for the rr_v3 database
 */
 ...
 * @description Includes all indexes needed for Phases 1-3, to avoid later upgrades
 */
 ...
 * @param storeNames Store name(s) (one or more)
