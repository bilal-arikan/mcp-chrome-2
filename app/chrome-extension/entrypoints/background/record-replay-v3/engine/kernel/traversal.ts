 ...
 * @description Provides validation, traversal, and next-node lookup for the Flow DAG
 */
...
export function validateFlowDAG(flow: FlowV3): ValidateFlowDAGResult {
  ...
  // Check whether the nodes referenced by edges exist
 ...
 * @returns The next node ID, or null if there is no successor node
 */
...
/**
 * Find an edge with the specified label
 */
