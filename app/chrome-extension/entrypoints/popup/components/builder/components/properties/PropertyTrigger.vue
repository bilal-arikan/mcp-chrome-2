<template>
  ...
  <div class="form-section">
    <div class="section-header"><span class="section-title">Trigger type</span></div>
    <div class="form-group checkbox-group">
      <label class="checkbox-label"
  ...
  <div v-if="cfg.modes.url" class="form-section">
    <div class="section-title">Visit URL matching</div>
  ...
  <div v-if="cfg.modes.command" class="form-section">
    ...
    <div class="text-xs text-slate-500" style="padding: 0 20px"
      >Note: Chrome extension shortcuts must be statically declared in the manifest and cannot be
