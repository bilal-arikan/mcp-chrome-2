<template>
  <div class="popup-container agent-theme" :data-agent-theme="agentTheme">
        ...
        <div class="section">
          ...
          <div class="rr-icon-buttons">
            <button
              ...
              data-tooltip="Recording feature in development"
            >
            ...
            <button
              ...
              data-tooltip="Enable page editing mode"
            >
              <EditIcon />
            </button>
            <button
        ...
        <div class="section">
          ...
          <div class="entry-card">
            ...
            <button class="entry-item" @click="openElementMarkerSidepanel">
              ...
              <div class="entry-content">
                <span class="entry-title">Element Annotation</span>
    ...
    <!-- Sidebar handles workflow management; the editor opens in a standalone window -->
...
// AgentChat theme - obtained from preload, kept consistent with the sidepanel
...
// The flow editor opens in a standalone window; the popup no longer shows a cluttered list
...
// Run records and overrides are viewed on the sidebar page
const startRecording = async () => {
  // TODO: record & replay feature in development, temporarily intercepted
    ...
    try {
      ...
      if (result && result.success === false) {
        ...
        if (failed && failed.stepId) {
          // Open a standalone editor window and locate the failed node
...
// The old "clone/publish/schedule/overrides" are handled in the sidebar or editor
...
function openWorkflowSidepanel() {
  // TODO: workflow feature in development, temporarily intercepted
...
async function toggleElementMarker() {
  try {
    ...
    if (!tab?.id) {
      console.warn('Unable to get the current tab');
      return;
    }

    // Send a message to the background to start element annotation
