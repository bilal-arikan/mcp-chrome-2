 ...
 *
 * Note: Uses a bidirectional scan strategy, expanding outward from the target
 * position to both sides, to avoid missing nearby elements entirely when the
 * target is in the latter half of the children list.
 */
 ...
 *
 * Note:
 * - When alignment occurs, show the gap in the "other direction"
 * - lockX is a vertical guide line, so show the gap along the Y axis
 * - lockY is a horizontal guide line, so show the gap along the X axis
 */
