...
function createDisplayIcon(value: DisplayValue): SVGElement {
  ...
  switch (value) {
    case 'block':
      // Two full-width block-level elements stacked vertically
      addBlock(3.5, 3.5, 8, 3);
      addBlock(3.5, 8.5, 8, 3);
      break;
    case 'inline':
      // Three lines of text representing inline flow
      addLine(3.5, 4.5, 8);
      addLine(3.5, 7.5, 5);
    ...
    case 'inline-block':
      ...
      break;
    case 'flex':
      // Three flex children arranged horizontally
...
function createHorizontalAlignIcon(value: AlignmentAxisValue): SVGElement {
  ...
  // X coordinate of content blocks varies by alignment
...
function createVerticalAlignIcon(value: AlignmentAxisValue): SVGElement {
  ...
  // Y coordinate of content blocks varies by alignment
