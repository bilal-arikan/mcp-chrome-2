 ...
 * @description Bridges the Builder V2 Flow type with the V3 RPC FlowV3 type
 *
 * Design notes:
 ...
 * @returns The V3 Flow and warning messages
 * @throws Throws an error when conversion fails
 */
 ...
 * @param flowV3 The V3 Flow obtained from RPC
 * @returns The V2 Flow and warning messages
 * @throws Throws an error when conversion fails
 */
 ...
 * @description Used to detect the JSON format during import
 */
 ...
 * @description Supports a single Flow, an array of Flows, or the { flows: Flow[] } format
 */
